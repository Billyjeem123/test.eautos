...
{{--      </li>--}}
      ...
      <li class="nav-item">
        ...
        <li class="nav-item">
            <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#collapseUtilities1063"
               aria-expanded="true" aria-controls="collapseUtilities1063">
                <i class="fas fa-user-circle"></i>


                <span>Groups</span>
            </a>
            <div id="collapseUtilities1063" class="collapse" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
                <div class="bg-white py-2 collapse-inner rounded">
                    <h6 class="collapse-header">Groups</h6>
                    <a class="collapse-item" href="{{route('group_creation_page')}}">Create Group</a>
                    <a class="collapse-item" href="{{route('get_all_group_admin')}}">Group  Listings</a>
                </div>
            </div>
        </li>
      ...
      <footer class="sticky-footer bg-white">
        <div class="container my-auto">
          <div class="copyright text-center my-auto">
            <span>Copyright &copy; Essential Nigeria {{ date('Y') }}</span>
          </div>
        </div>
      </footer>
      <!-- End of Footer -->
