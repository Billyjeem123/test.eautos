...
@section('page.content')
    ...
    <div class="container-fluid">
        ...
        <form class="p-3"   method="POST"   enctype="multipart/form-data"  action="{{route('admin.auction.create')}}">
            @csrf
            ...
            <div class="form-row justify-content-between mb-3">
                <div class="form-group col-md-6">
                    <input type="text" id="starting_date" name="starting_date" class="form-control bg-white" placeholder="Select starting date">
                </div>

                <div class="form-group col-md-6">
                    <input type="text" id="ending_date" name="ending_date" class="form-control bg-white" placeholder="Select ending date">
                </div>
            </div>
