    ...
    <div class="modal-dialog modal-dialog-centered modal-xl"> <!-- Adjust modal size to extra large and centering -->
        <div class="modal-content">
            ...
            <div class="modal-header">
                ...
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close" onclick="window.location.href='{{ route('sold.all')}}';"></button>
            </div>
            ...
            <div class="modal-footer">
                <a href="{{ route('sold.all')}}" class="btn btn-primary">Back</a>
            </div>
        </div>
    </div>
</div>
